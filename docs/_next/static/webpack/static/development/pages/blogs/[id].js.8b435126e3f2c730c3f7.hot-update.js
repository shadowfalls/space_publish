...
var getBlog = function getBlog(id) {
  ...
  var url = _constants_constants__WEBPACK_IMPORTED_MODULE_1__["isLocal"] ? "".concat(_constants_constants__WEBPACK_IMPORTED_MODULE_1__["localBaseUrl"], "/api/get_article/").concat(id, "?clearCache=").concat(random) : "".concat(_constants_constants__WEBPACK_IMPORTED_MODULE_1__["baseUrl"], "/api/articles/").concat(id, ".json?clearCache=").concat(random);
  return axios__WEBPACK_IMPORTED_MODULE_0___default.a.get(url);
};
...
//# sourceMappingURL=[id].js.8b435126e3f2c730c3f7.hot-update.js.map